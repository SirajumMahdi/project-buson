            ...
            <div class="col-lg-3 offset-lg-1">
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3><?php echo $buson_options['cti-1']; ?></h3>
                        <p><?php echo $buson_options['cti-2']; ?></p>
                    </div>
                </div>
                <div class="media contact-info">
                    <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                    <div class="media-body">
                        <h3><?php echo $buson_options['ctn']; ?></h3>
                        <p><?php echo $buson_options['ctnt']; ?></p>
                    </div>
                </div>
                <div class="media contact-info">
                    <span class="contact-info__icon"><i class="ti-email"></i></span>
                    <div class="media-body">
                        <h3><?php echo $buson_options['cte']; ?></h3>
                        <p><?php echo $buson_options['ctet']; ?></p>
                    </div>
                </div>
            </div>
        </div>
